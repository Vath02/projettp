...
CREATE TABLE c19v12_order_items(
	...
	,CONSTRAINT c19v12_order_items_c19v12_users0_FK FOREIGN KEY (id_c19v12_users) REFERENCES c19v12_users(id)
)ENGINE=InnoDB;
...
CREATE TABLE c19v12_orders(
        ...
        id_c19v12_order_items Int NOT NULL
	,CONSTRAINT c19v12_orders_PK PRIMARY KEY (id)

	,CONSTRAINT c19v12_orders_c19v12_order_items_FK FOREIGN KEY (id_c19v12_order_items) REFERENCES c19v12_order_items(id)
)ENGINE=InnoDB;
